...
/* 22 */     setLocation(entity, location.getX(), location.getY(), location.getZ(), location.getYaw(), location.getPitch(), false, false);
/*    */   }
/*    */   
/*    */   default void setLocation(AbstractEntity entity, double x, double y, double z, float yaw, float pitch) {
/* 26 */     setLocation(entity, x, y, z, yaw, pitch, false, false);
/*    */   }
/*    */   
...
/*    */   
/*    */   void sendPlayerFakeInventoryItem(AbstractPlayer paramAbstractPlayer, ItemStack paramItemStack, int paramInt);
/*    */   
/*    */   default void setEntityPitch(AbstractEntity target, float pitch) {}
/*    */ }


/* Location:              D:\JavaProject\RidePet\libs\MythicMobsAPI\!\lumine\xikage\mythicmobs\volatilecode\handlers\VolatileEntityHandler.class
