...
/*     */   public CompoundTag_v1_8_R3(Map<String, Tag> value) {
/*  20 */     super(value);
/*     */   }
/*     */   
...
/*  36 */         tag.set(entry.getKey(), (NBTBase)((io.lumine.xikage.mythicmobs.volatilecode.v1_8_R3.CompoundTag_v1_8_R3)entry.getValue()).toNMSTag()); continue;
/*     */       } 
...
/*  53 */           io.lumine.xikage.mythicmobs.volatilecode.v1_8_R3.CompoundTag_v1_8_R3 comp = new io.lumine.xikage.mythicmobs.volatilecode.v1_8_R3.CompoundTag_v1_8_R3(btags);
...
/*  79 */         tags.put(key, new ByteTag(((NBTTagByte)base).f())); continue;
/*     */       } 
/*  81 */       if (base instanceof NBTTagFloat) {
/*  82 */         tags.put(key, new FloatTag(((NBTTagFloat)base).h())); continue;
/*     */       } 
/*  84 */       if (base instanceof NBTTagDouble) {
/*  85 */         tags.put(key, new DoubleTag(((NBTTagDouble)base).g())); continue;
/*     */       } 
...
/*  91 */         tags.put(key, new IntArrayTag(((NBTTagIntArray)base).c())); continue;
/*     */       } 
/*  93 */       if (base instanceof NBTTagCompound) {
/*  94 */         tags.put(key, fromNMSTag((NBTTagCompound)base)); continue;
/*     */       } 
/*  96 */       if (base instanceof net.minecraft.server.v1_8_R3.NBTTagEnd) {
...
/* 103 */         tags.put(key, new ShortTag((short)((NBTTagShort)base).f())); continue;
/*     */       } 
/* 105 */       if (base instanceof NBTTagString) {
/* 106 */         tags.put(key, new StringTag(((NBTTagString)base).a_()));
/*     */       }
/*     */     } 
/* 109 */     return new io.lumine.xikage.mythicmobs.volatilecode.v1_8_R3.CompoundTag_v1_8_R3(tags);
/*     */   }
/*     */ }


/* Location:              D:\JavaProject\RidePet\libs\MythicMobsAPI\!\lumine\xikage\mythicmobs\volatilecode\v1_8_R3\CompoundTag_v1_8_R3.class
