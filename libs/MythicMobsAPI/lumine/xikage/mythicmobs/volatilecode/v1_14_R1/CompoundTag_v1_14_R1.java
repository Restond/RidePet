...
/*     */ 
/*     */ public class CompoundTag_v1_14_R1 extends CompoundTag {
/*     */   public CompoundTag_v1_14_R1(Map<String, Tag> value) {
/*  20 */     super(value);
/*     */   }
/*     */   
...
/*  36 */         tag.set(entry.getKey(), (NBTBase)((io.lumine.xikage.mythicmobs.volatilecode.v1_14_R1.CompoundTag_v1_14_R1)entry.getValue()).toNMSTag()); continue;
/*     */       } 
...
/*  53 */           io.lumine.xikage.mythicmobs.volatilecode.v1_14_R1.CompoundTag_v1_14_R1 comp = new io.lumine.xikage.mythicmobs.volatilecode.v1_14_R1.CompoundTag_v1_14_R1(btags);
...
/*  73 */     for (String key : tag.getKeys()) {
/*  74 */       NBTBase base = tag.get(key);
/*  75 */       if (base instanceof NBTTagInt) {
/*  76 */         tags.put(key, new IntTag(((NBTTagInt)base).asInt())); continue;
/*     */       } 
/*  78 */       if (base instanceof NBTTagByte) {
/*  79 */         tags.put(key, new ByteTag(((NBTTagByte)base).asByte())); continue;
/*     */       } 
/*  81 */       if (base instanceof NBTTagFloat) {
/*  82 */         tags.put(key, new FloatTag(((NBTTagFloat)base).asFloat())); continue;
/*     */       } 
...
/*     */       } 
/*     */     } 
/* 125 */     return new io.lumine.xikage.mythicmobs.volatilecode.v1_14_R1.CompoundTag_v1_14_R1(tags);
/*     */   }
/*     */ }


/* Location:              D:\JavaProject\RidePet\libs\MythicMobsAPI\!\lumine\xikage\mythicmobs\volatilecode\v1_14_R1\CompoundTag_v1_14_R1.class
