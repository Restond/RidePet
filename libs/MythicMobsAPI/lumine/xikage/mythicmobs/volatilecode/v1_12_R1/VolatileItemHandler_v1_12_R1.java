...
/* 31 */     ItemStack nmsItemStack = (ItemStack)this.refItemStack.get(itemStack, "handle");
/* 32 */     NBTTagCompound tag = nmsItemStack.hasTag() ? nmsItemStack.getTag() : new NBTTagCompound();
/* 33 */     CompoundTag compound = CompoundTag_v1_12_R1.fromNMSTag(tag).createBuilder().put(key, value).build();
/* 34 */     nmsItemStack.setTag(((CompoundTag_v1_12_R1)compound).toNMSTag());
...
/* 42 */       return CompoundTag_v1_12_R1.fromNMSTag(nmsItemStack.getTag());
/*    */     }
/* 44 */     return (CompoundTag)new CompoundTag_v1_12_R1(new HashMap<>());
/*    */   }
/*    */ 
/*    */   
...
/* 50 */     nmsItemStack.setTag(((CompoundTag_v1_12_R1)compoundTag).toNMSTag());
/* 51 */     return CraftItemStack.asBukkitCopy(nmsItemStack);
/*    */   }
/*    */ }


/* Location:              D:\JavaProject\RidePet\libs\MythicMobsAPI\!\lumine\xikage\mythicmobs\volatilecode\v1_12_R1\VolatileItemHandler_v1_12_R1.class
