...
public interface AbstractEntity {
  ...
  boolean hasLineOfSight(io.lumine.xikage.mythicmobs.adapters.AbstractEntity paramAbstractEntity);
  ...
  io.lumine.xikage.mythicmobs.adapters.AbstractEntity getTarget();
  
  io.lumine.xikage.mythicmobs.adapters.AbstractEntity getVehicle();
  ...
  void setPassenger(io.lumine.xikage.mythicmobs.adapters.AbstractEntity paramAbstractEntity);
  ...
  boolean hasPotionEffect(String paramString, RangedDouble paramRangedDouble1, RangedDouble paramRangedDouble2);
  ...
  io.lumine.xikage.mythicmobs.adapters.AbstractEntity getPassenger();
...
/* Location:              D:\JavaProject\RidePet\libs\MythicMobsAPI\!\lumine\xikage\mythicmobs\adapters\AbstractEntity.class
