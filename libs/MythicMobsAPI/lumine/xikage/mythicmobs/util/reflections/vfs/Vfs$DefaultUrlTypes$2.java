...
/* 229 */         return (Vfs.Dir)new ZipDir(((JarURLConnection)urlConnection).getJarFile());
/*     */       }
/* 231 */     } catch (Throwable throwable) {}
/* 232 */     File file = Vfs.getFile(url);
/* 233 */     if (file != null) {
/* 234 */       return (Vfs.Dir)new ZipDir(new JarFile(file));
/*     */     }
/* 236 */     return null;
/*     */   }
/*     */ }
...
/* Location:              D:\JavaProject\RidePet\libs\MythicMobsAPI\!\lumine\xikage\mythicmob\\util\reflections\vfs\Vfs$DefaultUrlTypes$2.class
