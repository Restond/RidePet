...
/*  39 */       return (Vfs.Dir)new ZipDir(new JarFile(adaptedUrl.getFile()));
/*  40 */     } catch (Exception e) {
/*     */       try {
/*  42 */         return (Vfs.Dir)new ZipDir(new JarFile(url.getFile()));
...
/*     */ 
/*     */   
/*  88 */   Predicate<File> realFile = (Predicate<File>)new Object(this);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\JavaProject\RidePet\libs\MythicMobsAPI\!\lumine\xikage\mythicmob\\util\reflections\vfs\UrlTypeVFS.class
