...
/*     */ 
/*     */ import io.lumine.xikage.mythicmobs.util.ArrayWrapper;
...
/*  58 */       return _loadedNMSClasses.get(className);
/*     */     }
/*     */     
...
/*  82 */       return _loadedOBCClasses.get(className);
/*     */     }
/*     */     
...
/*     */     } else {
/* 140 */       loaded = _loadedFields.get(clazz);
/*     */     } 
/* 142 */     if (loaded.containsKey(name))
/*     */     {
/* 144 */       return loaded.get(name);
/*     */     }
/*     */     try {
...
/*     */     }
/*     */     
/* 192 */     Map<String, Map<ArrayWrapper<Class<?>>, Method>> loadedMethodNames = _loadedMethods.get(clazz);
/* 193 */     if (!loadedMethodNames.containsKey(name)) {
/* 194 */       loadedMethodNames.put(name, new HashMap<>());
/*     */     }
/*     */     
/* 197 */     Map<ArrayWrapper<Class<?>>, Method> loadedSignatures = loadedMethodNames.get(name);
/* 198 */     ArrayWrapper<Class<?>> wrappedArg = new ArrayWrapper((Object[])args);
/* 199 */     if (loadedSignatures.containsKey(wrappedArg)) {
/* 200 */       return loadedSignatures.get(wrappedArg);
/*     */     }
/*     */     
/* 203 */     for (Method m : clazz.getMethods()) {
/* 204 */       if (m.getName().equals(name) && Arrays.equals((Object[])args, (Object[])m.getParameterTypes())) {
...
/* Location:              D:\JavaProject\RidePet\libs\MythicMobsAPI\!\lumine\xikage\mythicmob\\util\NMSReflection.class
